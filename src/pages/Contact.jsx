...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    const loadingTimeout = setTimeout(() => setIsLoading(false), 5000); // 5 seconds minimum
    return () => {
  ...
  return (
    <div id="contact" className="relative bg-black w-screen overflow-x-hidden flex flex-col min-h-screen">
      <div className={`flex flex-1 ${isMobile ? 'justify-center' : 'flex-row'} mt-20`}>
        {/* Left Section: Form */}
        <div className={`flex items-center justify-center ${isMobile ? 'w-full' : 'w-1/2'} text-white px-4`}>
          <div className="bg-gradient-to-r from-[#ffad42] to-[#f30808] p-1 rounded-lg shadow-lg max-w-md w-full">
            <div className="bg-black p-6 rounded-lg">
              <h2 className="text-4xl font-bold text-center mb-6 bg-gradient-to-r from-[#ffad42] to-[#f30808] bg-clip-text text-transparent">
                Contact Us
              </h2>
              <form>
                <div className="mb-4">
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-2 rounded-lg bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-[#ffad42]"
                ...
                <button
                  type="submit"
                  className="w-full py-2 rounded-lg bg-gradient-to-r from-[#ffad42] to-[#f30808] text-white font-bold hover:opacity-90 transition-opacity"
                >
                  Send
                </button>
              </form>
        ...
        {/* Right Section: 3D Object */}
        {!isMobile && (
          <div className="flex items-center justify-center w-1/2">
            <Canvas
              className="w-full h-full bg-transparent"
              camera={{ near: 0.2, far: 5000 }}
            ...
            >
              <Suspense fallback={<Loader />}>
                ...
                <Plane
                  ...
                  onRender={() => console.log("3D object rendered")}
                />
              </Suspense>
            </Canvas>
          </div>
      ...
      {/* Footer */}
      <footer className="w-full bg-black text-white text-center py-6 flex flex-col items-center mt-auto">
